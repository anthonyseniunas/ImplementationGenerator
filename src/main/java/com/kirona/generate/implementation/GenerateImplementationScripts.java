...
private static String scriptDataMappingTypes;
	...
	public static void generateWirelessParameterReport()
	{
			  ...
			  for (int i = 0; i < wirelessParameters.length; i++)
        {
			    ...
			    String parameterName = wirelessParameters[i];
			    
			    WirelessParameter wirelessParameter = generateDao.getWirelessParameter(parameterName);
			    
			    if (wirelessParameter !=null)
			    {
			      writer.println("************************************************************************");
			      writer.println("*                EXISTING WIRELESS PARAMETER "+parameterName);
			      writer.println("************************************************************************");
		        writer.println("");
		        writer.println("PROMPT Updating Parameter "+parameterName);
		        writer.println("");
		        writer.println("UPDATE wireless_parameters");
		        writer.println("SET wpm_parameter_value='"+wirelessParameter.getValue()+"'");
		        writer.println("WHERE wpm_parameter='"+parameterName+"';");
		        writer.println("");
			    }
			    else 
			    {
            ...
            writer.println("************************************************************************");
            writer.println("*                 NEW WIRELESS PARAMETER "+parameterName);
            writer.println("************************************************************************");
            writer.println("");
            writer.println("PROMPT Updating Parameter "+parameterName);
            writer.println("");
            writer.println("UPDATE wireless_parameters");
            writer.println("SET wpm_parameter_value='UNSET'");
            writer.println("WHERE wpm_parameter='"+parameterName+"';");
            writer.println("");
